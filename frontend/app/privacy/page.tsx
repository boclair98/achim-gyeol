...
export default function PrivacyPage() {
  return <main className="enterprise-shell"><SiteHeader context="PRIVACY POLICY" /><LegalDocument title="개인정보처리방침" updated="시행일 · 2026년 8월 15일">
    ...
    <section><h2>3. 외부 처리</h2><p>서비스 운영에는 coders.kr의 호스팅·PostgreSQL·암호화 백업 저장소, OpenAI의 뉴스 요약 API, NAVER API HUB·GDELT Cloud·공공기관 RSS의 뉴스 수집 기능, 이용 중인 브라우저의 웹푸시 제공자가 사용됩니다. 독자 식별정보는 AI 뉴스 요약 요청에 포함하지 않으며, 웹푸시 제공자에는 endpoint와 암호화된 알림만 전달됩니다.</p></section>
