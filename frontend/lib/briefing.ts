...
export type Story = { id: number; category: "정책" | "경제" | "사회" | "테크"; title: string; summary: string; whyItMatters: string; verificationStatus: "VERIFIED" | "DEVELOPING" | "CONFLICTING"; sources: Source[] };
