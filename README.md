...
- 한 카드에는 뉴스 2건을 배치해 휴대폰에서도 한 주제씩 차분히 읽을 수 있게 합니다.
...
휴대폰에서는 카드를 손가락으로 좌우로 밀거나 아래의 화살표 버튼을 누릅니다. PC에서는 화살표 버튼과 가로 스크롤을 사용할 수 있습니다. 카드 번호는 현재 위치와 전체 카드 수를 표시합니다.

```text
잠금화면의 아침결 푸시
          ↓ 누르기
2건씩 정리된 브리핑 카드 좌우로 넘기기
          ↓ 더 확인할 뉴스 선택
