...
푸시를 누르면 `/briefing` 맨 위에 **옆으로 넘기는 데일리 브리핑 카드**가 먼저 표시됩니다. 단순히 제목과 한두 문장만 모은 카드가 아니라, 바쁜 아침에도 중요한 사실과 판단 근거를 놓치지 않도록 다음 구조로 제공합니다.

- 한 카드에는 뉴스 1건만 배치해 카드 안에서 위아래로 뉴스를 찾지 않아도 됩니다.
